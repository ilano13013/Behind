...
export const SPEECH = {
  dormir: ['Zzz…', 'mmh…', '…encore cinq minutes', 'Zzz… non… pas le formulaire…', '…pas les impôts…'],
  reveil: ['Déjà ?', 'Non.', 'Il est quelle heure là', 'J\'ai dormi 20 minutes.', 'Qui a inventé le lundi'],
  manger: ['Miam', 'C\'est froid.', 'Je mange sain à partir de demain', 'Encore des pâtes', 'Y\'a plus de pain'],
  cuisiner: ['Ça va être bon ça', 'J\'improvise', 'C\'est pas censé fumer', 'Recette de mamie', 'Bon. C\'est carbonisé.'],
  douche: ['♪♪♪', 'L\'eau est glacée', 'Y\'a jamais de pression', 'Je chante pas fort quand même'],
  tv: ['Mais bien sûr…', 'Il va se faire avoir', 'Rediffusion. Encore.', 'C\'était mieux avant', 'Chut, ça commence'],
  musique: ['♪', '♫', 'Cette basse !', 'Je baisse dans dix minutes', '♪ ♫ ♪'],
  menage: ['Ça se voit que je viens de faire ?', 'D\'où vient cette chaussette', 'Trois heures pour ça', 'Bon, j\'ai poussé sous le lit'],
  travail: ['Encore un mail', 'Je réponds demain', 'Ils sont sérieux ?', 'Bon. Je m\'y mets.', 'Réunion pour dire qu\'on refera une réunion'],
  ennui: ['Bon.', '…', 'Il se passe rien', 'Je vais regarder par la fenêtre', 'J\'ai fini internet'],
  telephone: ['Ouiii je sais', 'Maman je te rappelle', 'Non j\'ai pas oublié', 'Allô ? Allô ? Je te perds', 'C\'est une arnaque, encore'],
  lecture: ['Deux pages, et je dors', 'Ah quand même', 'Je relis la même ligne'],
  sport: ['Trois. Quatre. …Trois.', 'Demain j\'y retourne', 'Ça compte les escaliers ?', 'Ça brûle'],
  jeu: ['NON !', 'C\'était pas moi', 'Dernière partie', 'Dernière partie (2)', 'Cette manette est cassée'],
  ...
  espionnage: ['Tiens tiens…', 'Il rentre à cette heure-là', 'Je regarde pas, je passais', 'Elle a changé de voiture'],
  ...
  triste: ['…', 'Ça va aller', 'C\'est rien', 'Je suis fatigué c\'est tout'],
  stresse: ['Ça va, ça va, ça va', 'Faut que je réfléchisse', 'Je gère.', 'Je gère pas.'],
  heureux: ['Belle journée', '♪', 'Franchement, ça va', 'J\'ai bien fait de rester'],
